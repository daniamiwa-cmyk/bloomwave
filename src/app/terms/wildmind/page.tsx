...
export const metadata: Metadata = {
  title: 'Terms of Service — WildMind | BloomWave',
  description: 'Terms of service for WildMind by BloomWave.',
}

export default function WildMindTermsPage() {
  return (
      ...
      <article className="max-w-3xl mx-auto px-6">
        ...
        <div className="prose-policy space-y-10 text-bark-500 leading-relaxed">
          ...
          <section>
            ...
            <p>
              By downloading or using WildMind, you agree to these Terms of
          ...
          <section>
            ...
            <p>
              You must be at least 13 years old to use WildMind. By using the
          ...
          <section>
            ...
            <p>
              WildMind is a nature oracle and field journal app. It provides
              daily animal oracle card pulls, nature journaling with photo
              attachments, and an animal encyclopedia organized by realm. All
              content is for personal enrichment and creative exploration
              purposes only. WildMind is not a substitute for professional
          ...
          <section>
            ...
            <p className="mb-3">
              WildMind requires an account to use. You are responsible for:
            </p>
          ...
          <section>
            ...
            <p className="mb-3">
              WildMind offers optional premium subscriptions.
            </p>
            <ul className="list-disc pl-5 space-y-1 text-sm">
              <li>
          ...
          <section>
            ...
            <p className="mb-3">
              You retain ownership of all content you create in WildMind,
              including journal entries and photos. By using the app, you grant
              us a limited license to store and display your content solely for
              the purpose of providing the service to you.
            </p>
            <p>
              You are solely responsible for the content you create and upload.
              Do not upload content that is illegal, harmful, or violates the
              rights of others.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1 text-sm">
              ...
              <li>
                Upload content that is illegal, harmful, or infringes on the
                rights of others
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              The WildMind app, including its design, code, illustrations,
              oracle card artwork, animal descriptions, and all other creative
          ...
          <section>
            ...
            <p>
              WildMind is provided &ldquo;as is&rdquo; and &ldquo;as
